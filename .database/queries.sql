...
INSERT INTO Reviews (user_id, date, score, game, review) VALUES
    ('1', '2025-10-23', '3', 'Alien Isolation', 'Great game!'),
    ('1', '2025-09-12', '2', 'Starship Troopers', 'Not bad.'),
    ('2', '1997-05-25', '6', 'Zenless Zone Zero', 'Amazing!'),
    ('2', '1998-03-18', '0', 'Zelda Ocarina of Time', 'Terrible.'),
    ('3', '2007-05-25', '1', 'Warcraft III', 'Could be better.'),
    ('3', '2013-03-24', '3', 'Dead Space 2', 'Scary!'),
    ('4', '2015-05-04', '5', 'HiFi Rush', 'Loved it.'),
    ('4', '2023-05-02', '3', 'Palword', 'Fun game.'),
    ('5', '1999-09-13', '3', 'House for DS', 'Interesting.'),
    ('5', '2001-01-06', '2', 'Counter Strike Global Offensive', 'Not my type.');

-- Update a review
UPDATE Reviews SET score = 4, review = 'Updated review' WHERE id = 1;
